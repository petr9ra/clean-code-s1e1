...
var incompleteTaskHolder=document.querySelector('.task-list--todo');//ul of .todoTasks
var completedTasksHolder=document.querySelector('.task-list--completed');//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.classList.add('checkbox', 'task-item__checkbox');
    editInput.type='text';
    editInput.classList.add('input', 'task-item__input');

    editButton.innerText='Edit'; //innerText encodes special characters, HTML does not.
    editButton.classList.add('task-item__edit-btn', 'btn')

    deleteButton.classList.add('task-item__delete-btn', 'btn');
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains('task-item--edit-mode');
